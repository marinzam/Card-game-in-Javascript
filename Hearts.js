...
TrickStartEvent.prototype.toString = function () {
    return "Let's begin: " + this.getStartPos() + " leads."
}
...
TrickContinueEvent.prototype.toString = function () {
    return "Next: " + this.getNextPos() + "'s turn.";
}
...
TrickCompleteEvent.prototype.toString = function () {
    return "Trick complete: " + this.getTrick().getWinner() + " won this trick with " +
	(this.getTrick().hasPoints() ? this.getTrick().getPoints()+" points" : "no points") + ".";
}
...
GameStartedEvent.prototype.toString = function () {
    ...
    var str = "Passing turn: ";
    switch (this.getPassType()) {
    case Hearts.PASS_LEFT: str += "Select 3 cards to pass left."; break;
    case Hearts.PASS_RIGHT: str += "Select 3 cards to pass right."; break;
    case Hearts.PASS_ACROSS: str += "Select 3 cards to pass across."; break;
    case Hearts.PASS_NONE: str += "No passing this turn."; break;
    }
    return str;
}
...
CardPlayedEvent.prototype.toString = function() {
    return "" + this.getPosition() + " played " + this.getCard();
}
